...
export default function StoryForm({ onStoryGenerated, onError }: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <label htmlFor="story_length" className="block text-sm font-medium text-slate-700 mb-1">
            Story Length
          </label>
          <select
            id="story_length"
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex items-center">
            ...
            />
            <span className="ml-2 w-12 text-sm text-slate-700">{form.temperature}</span>
          </div>
